...
const inputEmbeddedInGroupVariants = cva(
  "w-full min-h-0 min-w-0 flex-1 border-0 bg-transparent [font-family:var(--font-inter)] transition-colors outline-none file:inline-flex file:border-0 file:bg-transparent file:font-uds-regular file:text-foreground placeholder:text-uds-text-placeholder disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-transparent disabled:text-[var(--uds-text-disabled)] focus-visible:border-transparent focus-visible:ring-0 aria-invalid:border-transparent aria-invalid:ring-0 dark:bg-transparent dark:disabled:bg-transparent dark:aria-invalid:border-transparent dark:aria-invalid:ring-0 rounded-none py-0 shadow-none ring-0 h-full",
  {
    variants: {
      inputSize: {
        default:
