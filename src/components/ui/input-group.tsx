  ...
  return (
    <div
      ...
      className={cn(
        ...
        "relative flex w-full min-w-0 flex-row flex-nowrap items-center rounded-[length:var(--uds-radius-4)] border border-input bg-[var(--uds-surface-primary)] transition-colors outline-none has-[input:autofill]:bg-[var(--uds-color-primary-25)] has-[input:disabled]:bg-[var(--uds-surface-disabled)]",
